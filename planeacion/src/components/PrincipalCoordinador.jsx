...
const PrincipalCoordinador = ({ setIsAuthenticated }) => {
  ...
  const handleDetalles = (id) => {
    navigate(`/detalles-coordinador/${id}`);
  };

  const handleCompleto = () =>{
navigate (`/pedido-completo-coordinador`)
  }
  ...
  return (
    <div className='container mt-5'>
      ...
      <div>
        ...
        <button className='btn btn-success' onClick={handleCompleto} style={{marginLeft:'50px' }}>Pedidos Completos</button>
      </div>
      <br />
